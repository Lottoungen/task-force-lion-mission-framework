...
comment "Add weapons";
player addWeapon "JCA_arifle_M4A4_GL_black_F";
...
player addVest "milgp_lot_v_marciras_grenadier_belt_rgr";
...
for "_i" from 1 to 3 do {player addItemToBackpack "ACE_40mm_Flare_white"};
