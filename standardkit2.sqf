...
comment "Add weapons";
player addWeapon "LOT_SCARL_black";
player addPrimaryWeaponItem "Tier1_AAC_M42000_Black";
player addPrimaryWeaponItem "rhsusf_acc_anpeq15side_bk";
player addPrimaryWeaponItem "rhsusf_acc_su230_mrds";
player addPrimaryWeaponItem "rhs_mag_30Rnd_556x45_M855A1_Stanag_Pull";
...
player forceAddUniform "u_m21_uniform_t08";
player addVest "lot_v_extd_marciras_assaulter_belt_01_t08";
player addBackpack "lot_aaf_Backpack_Pocket2";
...
for "_i" from 1 to 8 do {player addItemToVest "rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red";};
player addItemToBackpack "lot_scrim_jungle6";
for "_i" from 1 to 7 do {player addItemToBackpack "rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red";};
player addHeadgear "lot_aaf_rhsusf_opscore_t07_cov_t08_cam";
